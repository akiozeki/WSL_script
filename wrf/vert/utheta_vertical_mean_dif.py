...
#
#    
#contour=ax.contour(idx,vert,theta1_mean,levels=cmaplev,colors="black",linewidth=1.0)
#ax.clabel(contour)
#
#xstep=4
...
#plt.savefig(f"{fig_dir}/{ex1}/vert/{ex1}-{case}vertical.png")
#plt.close("all")
...
contour=ax.contour(idx,vert,theta2_mean,levels=cmaplev,colors="black",linewidth=1.0)
ax.clabel(contour)
...
plt.tight_layout()
#ax.invert_yaxis()鉛直軸反転
plt.savefig(f"{fig_dir}/{ex2}/vert/{ex2}-{case}vertical.png")
plt.close("all")
...
contour=ax.contour(idx,vert,theta_dif,levels=cmaplev_a,colors="black",linewidth=1.0)
ax.clabel(contour)
...
plt.tight_layout()
#ax.invert_yaxis()鉛直軸反転
plt.savefig(f"{fig_dir}/{ex2}/vert/Dif-{case}vertical.png")
plt.close("all")
