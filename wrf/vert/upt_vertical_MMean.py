...
plt.savefig(f"{fig_dir}/{ex1}/vert/{ex1}MMean-{case}vertical{start_lat}.png")
plt.close("all")
...
plt.tight_layout()
#ax.invert_yaxis()鉛直軸反転
plt.savefig(f"{fig_dir}/{ex2}/vert/{ex2}-MMean-{case}vertical{start_lat}.png")
plt.close("all")
...
plt.tight_layout()
#ax.invert_yaxis()鉛直軸反転
plt.savefig(f"{fig_dir}/{ex2}/vert/Dif-MMean-{case}vertical{start_lat}.png")
plt.close("all")
